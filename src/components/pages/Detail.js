import { Box, Text, Image, Icon, Flex } from "@chakra-ui/react";
...
export default function Detail(props) {
  ...
  let nextProject =
    nextProjectIndex === projectArray.length
      ? projectArray[0]
    ...
    <Box w={props.w} m="auto" pos="relative">
      ...
      >
        ...
        >
          ...
          <Box>
            <H2 as="h2">{toTitleCase(previousProject.name)}</H2>
        ...
        >
          ...
          <Box>
            <H2 as="h2">{toTitleCase(nextProject.name)}</H2>
